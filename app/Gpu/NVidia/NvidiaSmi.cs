...
public static class NvidiaSmi
{
    ...
    public static int GetMaxGPUPower()
    {
        ...
        if (float.TryParse(output, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out float floatValue))
        {
    ...
    public static string RunNvidiaSmiCommand(string arguments = "-i 0 -q")
    {
