...
namespace GHelper.Helpers
{
    ...
    public class OSDNativeForm : NativeWindow, IDisposable
    {
        ...
        private void CreateWindowOnly()
        {
            ...
            params1.ExStyle = User32.WS_EX_TOPMOST | User32.WS_EX_TOOLWINDOW | User32.WS_EX_LAYERED | User32.WS_EX_NOACTIVATE;
            
            if (ClickThrough)
            {
                params1.ExStyle |= User32.WS_EX_TRANSPARENT;
            }
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == WM_MOVE)
            {
                ...
                // Handle negative coordinates (multi-monitor setup)
                if (x > 32767) x -= 65536;
                if (y > 32767) y -= 65536;
