...
namespace GHelper
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            checkMonitor.Dock = DockStyle.Left;
            checkMonitor.Location = new Point(236, 0);
            checkMonitor.Margin = new Padding(11, 5, 11, 5);
            checkMonitor.Name = "checkMonitor";
            checkMonitor.Padding = new Padding(10, 0, 10, 0);
            checkMonitor.Size = new Size(200, 50);
            checkMonitor.TabIndex = 22;
            checkMonitor.Text = "Floating Monitor";
            checkMonitor.UseVisualStyleBackColor = true;

            panelStartup.Controls.Add(checkMonitor);
